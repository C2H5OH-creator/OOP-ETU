...
QT_MOC_LITERAL(4, 41, 7) // "getData"

    },
    "UDPCommunicator\0messageReceived\0\0"
    "message\0getData"
};
...
void UDPCommunicator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (UDPCommunicator::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UDPCommunicator::messageReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void UDPCommunicator::messageReceived(const QString & _t1)
{
